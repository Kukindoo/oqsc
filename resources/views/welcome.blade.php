                ...
                <div class="flex">
                    ...
                    <div class="shrink-0 flex items-center">
                        <a href="{{ route('welcome') }}">
                            <svg class="h-8 w-auto text-white lg:h-12 text-oqsc-heading-start" viewBox="0 0 62 65"
                                 fill="none"
                    ...
                    <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                        ...
                        <div class="text-center">
                            ...
                            <p class="mt-8 text-pretty text-lg font-medium text-gray-500 sm:text-xl/8">
                                Mission statement.... <span class="text-grey-100 opacity-20">Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo. Elit sunt amet fugiat veniam occaecat.</span>
                            </p>
                            <div class="mt-10 flex items-center justify-center gap-x-6">
                                <a href="#"
                                   ...
                                   focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Get
                                    started</a>
                                <a href="#" class="text-sm/6 font-semibold text-oqsc-cta">Learn more <span
...
{{--                        <a href="#" class="text-gray-400 hover:text-white">Partners</a>--}}
                    ...
                    <p class="mt-10 text-center text-sm/6 text-gray-400">&copy; 2025 OQSC, All rights reserved.  v0.1-alfa (PHP v{{ PHP_VERSION }})</p>
                </div>
            </footer>
        </div>
    </div>
